...
_lr_productions = [
  ...
  ('expression -> expression PLUS term','expression',3,'p_expression_plus','comp.py',44),
  ('expression -> expression MINUS term','expression',3,'p_expression_minus','comp.py',48),
  ('expression -> term','expression',1,'p_expression_term','comp.py',52),
  ('term -> term TIMES factor','term',3,'p_term_times','comp.py',56),
  ('term -> term DIVIDE factor','term',3,'p_term_divide','comp.py',60),
  ('term -> factor','term',1,'p_term_factor','comp.py',64),
  ('factor -> NUMBER','factor',1,'p_factor_number','comp.py',68),
  ('factor -> LPAREN expression RPAREN','factor',3,'p_factor_expr','comp.py',72),
]
